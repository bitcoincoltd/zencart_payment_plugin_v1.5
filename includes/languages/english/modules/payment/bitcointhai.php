...
*/
  ...
  define('MODULE_PAYMENT_BITCOINTHAI_TEXT_TITLE', 'Bitcoin');
  define('MODULE_PAYMENT_BITCOINTHAI_TEXT_DESCRIPTION', 'Bitcoin');
  define('MODULE_PAYMENT_BITCOINTHAI_TEXT_PAYMSG','You must send <strong>%s</strong> Bitcoins to the address: %s');
  define('MODULE_PAYMENT_BITCOINTHAI_TEXT_AFTERPAY','After you have completed payment please click the '.BUTTON_CONFIRM_ORDER_ALT.' button');
